...
export function AboutPage({ onNavigateToWork }: AboutPageProps) {
  ...
  const content = {
    en: {
      pageTitle: "About Me",
      pageDesc:
        "Designing interfaces that balance clarity, usability, and visual impact.",
      ...
      experiences: [
        {
          ...
          description:
            "Assisting the head of the study program in creating a website for students of the computer science study program.",
        ...
        },
        {
          ...
          description:
            "Working as a UI/UX Designer on freelance projects, focusing on interface design and user experience improvements.",
          period: "Present",
        },
      ],
      philosophyTitle: "Design Approach",
      philosophy1:
        "I believe good UI design is not just about aesthetics, but about clarity, consistency, and solving real user problems through thoughtful visual decisions. Every design choice should serve a purpose and enhance the user experience.",
      philosophy2:
        "My approach combines technical understanding with creative problem-solving, always keeping the end user at the center of every decision. I strive to create interfaces that are both beautiful and functional.",
    ...
    id: {
      ...
      pageDesc:
        "Mendesain antarmuka yang menyeimbangkan kejelasan, kegunaan, dan dampak visual.",
      ...
      experiences: [
        {
          ...
          organization: "Universitas Kristen Satya Wacana",
          description:
            "Membantu kepala program studi dalam membuat website untuk mahasiswa program studi ilmu komputer.",
        ...
        },
        {
          ...
          organization: "PT. Eintio",
          description:
            "Bekerja sebagai UI/UX Designer pada proyek freelance, fokus pada desain antarmuka dan peningkatan pengalaman pengguna.",
          period: "Saat Ini",
        },
      ],
      philosophyTitle: "Pendekatan Desain",
      philosophy1:
        "Saya percaya desain UI yang baik bukan hanya tentang estetika, tetapi tentang kejelasan, konsistensi, dan menyelesaikan masalah pengguna yang nyata melalui keputusan visual yang bijaksana. Setiap pilihan desain harus memiliki tujuan dan meningkatkan pengalaman pengguna.",
      philosophy2:
        "Pendekatan saya menggabungkan pemahaman teknis dengan pemecahan masalah kreatif, selalu menempatkan pengguna akhir di pusat setiap keputusan. Saya berusaha menciptakan antarmuka yang indah dan fungsional.",
      ctaTitle: "Mari Ciptakan Sesuatu yang Hebat",
      ctaDesc:
        "Tertarik untuk bekerja sama atau hanya ingin menyapa? Saya akan senang mendengar dari Anda.",
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">{t.bio1}</p>
              <p className="text-gray-700 text-lg leading-relaxed">{t.bio2}</p>
              <p className="text-gray-700 text-lg leading-relaxed">{t.bio3}</p>

              {/* Language Note */}
              <div className="pt-4 border-t border-gray-200">
                <p className="text-sm text-gray-500">
                  <span className="font-medium">{t.languageNote}</span>{" "}
                  {t.languageValue}
                </p>
              </div>
            </div>
